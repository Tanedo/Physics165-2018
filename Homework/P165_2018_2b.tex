...
\flip{Updated: 1/21, corrected a minus sign in (\ref{eq:rotation:matrix}). All $\theta$ should be replaced with $-\theta$ in the uncorrected version. Thanks Adam G.\ and Tommy W.\ 15 points to Gryffindor.}
