...
\item What is the order of magnitude of $M\Gamma$? (\textsc{Hint}: the rate for a process goes like the amplitude times its complex conjugate.) \flip{2/14 Hint: $M^2\Gamma^2$ sets the width of the $Z$ peak. What's a good characteristic size for this width? This should be identified with $(M^2\Gamma^2)^\#$, where $\#$ is from dimensional analysis.}
